  ...
  return (
    <section className="mt-20 mb-10 w-[80%] md:w-[40%]" ref={ref} id="contact">
      ...
      <div className="flex flex-col items-center ">
       <p> Зв'яжіться зі мною через форму,</p>
        <p>
          Email:{" "}
        ...
        <p className="flex items-center gap-2">
          ...
          <a
            ...
            target="_blank"
            className="hover:text-black transition-colors hover:bg-gray-500/30 cursor-pointer bg-gray-500/50 text-white text-md p-2   flex items-center gap-2 rounded-full"
          >
            @mugidar
          </a>
        </p>
